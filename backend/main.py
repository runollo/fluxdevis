...
from app.api.routes import offres, options, clients, devis, factures, simulation, generation, dashboard, documents, parametres
...
app.include_router(parametres.router, prefix="/api/parametres", tags=["Parametres"])
